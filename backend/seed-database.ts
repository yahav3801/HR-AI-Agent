  ...
  updates: z
    .object({
      ...
      contact_details: z
        ...
        .optional()
        .describe("Contact details to update"),
      ...
      job_details: z
        ...
        .optional()
        .describe("Job details to update"),

      skills: z
        .array(z.string())
        .optional()
        .describe("Replace current skills list"),

      // Special handling for reviews
      add_performance_review: z
        .object({
          review_date: z.string(),
        ...
        .optional()
        .describe(
          "Add a NEW performance review (cannot edit existing reviews)"
        ),

      notes: z.string().optional().describe("Update notes"),
    })
    .describe("Fields to update - only provide fields you want to change"),
});
...
export async function createEmployeeSummary(
  ...
  return new Promise((resolve) => {
    const jobDetails = `${employee.job_details.job_title} at ${employee.job_details.department}`;
...
async function seedDatabase(): Promise<void> {
  try {
    ...
    for (const record of recordsWithSummaries) {
      ...
      console.log(
        "Succesfully proccessed & saved record: ",
